<?php return array (
  'app' => 
  array (
    'name' => 'TestCenterEquipmentDatabase',
    'env' => 'local',
    'debug' => true,
    'url' => 'http://localhost',
    'asset_url' => NULL,
    ...
    'fallback_locale' => 'en',
    'faker_locale' => 'en_US',
    'key' => 'base64:tLmYfUrrZITzLIkSjFnV+PCAFxkdU+duUxjVSIlrrHo=',
    'cipher' => 'AES-256-CBC',
    'providers' => 
    array (
  ...
  array (
    ...
    'prefix' => 'testcenterequipmentdatabase_cache',
  ),
  'cors' => 
  array (
    'paths' => 
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'sqlite',
        'url' => NULL,
        'database' => 'testcenterequipmentdatabase',
        'prefix' => '',
    ...
    array (
      ...
      array (
        'cluster' => 'redis',
        'prefix' => 'testcenterequipmentdatabase_database_',
      ),
      'default' => 
      array (
        'url' => NULL,
...
',
    ...
    'temporary_files' => 
    array (
      'local_path' => '/var/www/app/storage/framework/cache/laravel-excel',
      'remote_disk' => NULL,
      'remote_prefix' => NULL,
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'local',
        'root' => '/var/www/app/storage/Backups',
      ),
      'restorationbackup' => 
      array (
        'driver' => 'local',
        'root' => '/var/www/app/storage/RestorationBackup',
      ),
      'public' => 
      array (
        'driver' => 'local',
  ...
  array (
    ...
    'cookie' => 'testcenterequipmentdatabase_session',
    'path' => '/',
    'domain' => NULL,
    'secure' => NULL,
    'http_only' => true,
  ...
  array (
    ...
    'defines' => 
    array (
      'font_dir' => '/var/www/app/storage/fonts',
      'font_cache' => '/var/www/app/storage/fonts',
      'temp_dir' => '/tmp',
      'chroot' => '/var/www/app',
